            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('mansor',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 30 ),
                  ),
                  ...
                  Card(
                    ...
                    child: ListTile(leading: Icon(Icons.email,color: Colors.teal,),
                      title: Text('mansour@gmail.com',style: TextStyle(fontSize: 15),),
                    ),
                  ),
                  Card(
                    margin: EdgeInsets.symmetric(vertical: 10,horizontal: 20),
                    child: ListTile(leading: Icon(Icons.telegram,color: Colors.teal,),
                      title: Text('@mansour',style: TextStyle(fontSize: 15),),
                    ),
                  ),
                  Card(
                    margin: EdgeInsets.symmetric(vertical: 10,horizontal:20),
